...
namespace BeiDream.SbsAbp.Common.Auditing
{
    public class BeiDreamAuditingHelper : IAuditingHelper, ITransientDependency
    {
        ...
        public AuditInfo CreateAuditInfo(Type type, MethodInfo method, IDictionary<string, object> arguments)
        {
            var auditInfo = new AuditInfo
            {
                ...
                CustomData = GetDescriptionAttrInfo(method),
        ...
        private string GetDescriptionAttrInfo(MethodInfo method)
        {
            var attr = method.GetCustomAttribute(typeof(DescriptionAttribute), false);
            if (attr == null)
            {
                return "";
            }
